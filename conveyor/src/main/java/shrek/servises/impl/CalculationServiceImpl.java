...
public class CalculationServiceImpl implements CalculationService {
    ...
    public CreditDTO calculation(ScoringDataDTO scoringDataDTO) throws ParametersValidationException {
        ...
        BigDecimal finalTotalAmount = isInsuranceTotalAmountCalculation(scoringDataDTO);
    ...
    @Override
    public BigDecimal isInsuranceTotalAmountCalculation(ScoringDataDTO scoringDataDTO) {
    ...
    @Override
    public BigDecimal pskCalculation(BigDecimal amount, List<PaymentScheduleElement> paymentScheduleElementList) {
        log.info("Расчет ПСК");
