...
class OffersServiceImplTest {
    ...
    void validAgeMoreThanEighteenTest() {
        LoanApplicationRequestDTO validAgeMoreThanEighteen = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
    ...
    void validAgeLessThanEighteen() {
        LoanApplicationRequestDTO validAgeLessThanEighteen = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("2007-01-29"));
    ...
    void creatingOfFullListOfRateChangesByIsInsuranceEnabledOrIsSalaryClientTest() {
        LoanApplicationRequestDTO validLoanApplicationRequestDTO = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
...
List<LoanOfferDTO> fullListOfRateChangesByIsInsuranceEnabledOrIsSalaryClient=offersService.offers(validLoanApplicationRequestDTO);
    ...
    void rateCheckIsInsuranceEnabledTrueLoanOffer() {
        LoanApplicationRequestDTO IsInsuranceEnabledTrue = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
...
Assertions.assertEquals(BASE_RATE.subtract(BigDecimal.valueOf(3)),IsInsuranceEnabledTrueLoanOfferDTO.getRate());
    ...
    void rateCheckIsInsuranceEnabledFalseLoanOffer() {
        LoanApplicationRequestDTO IsInsuranceEnabledFalse = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
    ...
    void rateCheckIsSalaryFalseLoanOffer() {
        LoanApplicationRequestDTO IsSalaryFalse = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
    ...
    void rateCheckIsSalaryTrueLoanOffer() {
        LoanApplicationRequestDTO IsSalaryTrue = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
    ...
    void rateCheckMonthlyPaymentIsNotNullLoanOffer() {
        LoanApplicationRequestDTO monthlyPaymentNotnull = LoanApplicationRequestDTOInitializer.loanAppReqInit(BigDecimal.valueOf(100000), 12, LocalDate.parse("1985-01-29"));
